...
user2 = User.create(first_name: "Bobbb", last_name: "Smbith", email: "bob@gmail.com", password: "123456",admin: true)
address1 = Address.create(user_id: user2.id, street: "2755 East 21st St.", street2: "Apt. #3", city: "Brooklyn", state_id: NewYork.id, zip: 11235)
payment1 = Payment.create(user_id: user2.id, network_id: Visa.id, cardholder: "Bob Smith", card_number: "1234567890123456", cvv: "953", expires: 20200401)
address2 = Address.create(user_id: user2.id, street: "2755 East 21st St.", street2: "Apt. #3", city: "Brooklyn", state_id: NewYork.id, zip: 11235)
payment2 = Payment.create(user_id: user2.id, network_id: Visa.id, cardholder: "Bob Smith", card_number: "1234567890123456", cvv: "953", expires: 20200401)
watched_list1 = WatchedList.create(user_id: user2.id)
watched_list1 = WatchedList.create(user_id: user2.id)
user2.watched_list_id = watched_list1.id
user2.address_id = address2.id
user2.payment_id = payment2.id
user2.save
