...
grocery = Category.create(title: "Groceries")
Item.create(title: "Banana",
            description: "Wholesome yellow goodness",
            price: "180",
            category_id: grocery.id,
            image: "http://sites.psu.edu/siowfa15/wp-content/uploads/sites/29639/2015/09/04_Apples.jpg",
...
Item.create(title: "Lettuce",
            ...
            price: "110",
            category_id: grocery.id,
            image: "http://www.vegkitchen.com/wp-content/uploads/2011/07/Romaine-lettuce.jpg",
...
Item.create(title: "Bacon",
            ...
            price: "599",
            category_id: grocery.id,
            image: "http://www.drserenamurray.com/wp-content/uploads/2013/02/1bacon0929.jpg",
...
Item.create(title: "Toothpaste",
            ...
            image: "http://www.personal.psu.edu/afr3/blogs/siowfa12/toothpaste.jpg",
...
Item.create(title: "Band-Aids",
            ...
            price: "299",
            category_id: health.id,
            image: "http://www.fluenceportland.com/wp-content/uploads/2012/11/Band-Aid.jpg",
...
Item.create(title: "Mouth Wash",
            ...
            price: "350",
            category_id: health.id,
            image: "https://sites.psu.edu/siowfa15/wp-content/uploads/sites/29639/2015/10/3001.jpg",
...
Item.create(title: "Advil",
            ...
            price: "925",
            category_id: health.id,
            image: "http://neopharmgroup.com/wp-content/uploads/2012/12/advil.jpg",
...
Item.create(title: "Paper Towels",
            ...
            price: "899",
            category_id: cleaning.id,
            image: "http://www.southernsavers.com/wp-content/uploads/2013/01/Paper-Towels.jpeg",
...
Item.create(title: "Trash Bags",
            ...
            price: "999",
            category_id: cleaning.id,
            image: "http://d2rormqr1qwzpz.cloudfront.net/photos/2013/07/02/49514-c26-b005gsyxhw-1-l.jpg",
...
Item.create(title: "Air Freshener",
            ...
            price: "599",
            category_id: cleaning.id,
            image: "https://s3-ap-southeast-1.amazonaws.com/media.redmart.com/newmedia/1600x/i/m/img_6565.jpg",
...
Item.create(title: "SmartWater",
            ...
            image: "http://wdy.h-cdn.co/assets/cm/15/08/54ea7fe1bc68a_-_h-wd0409-smart-water-3.jpg",
...
Item.create(title: "Izze",
            ...
            price: "90",
            category_id: beverages.id,
            image: "http://www.izze.com/media-resources/CanFamily.jpg",
...
Item.create(title: "Black Tea",
            ...
            price: "310",
            category_id: beverages.id,
            image: "http://ceylonteaco.blazonco.com/images/products/toctc/CatalogImages_OCT.jpg",
...
Item.create(title: "Horizon Organic Milk",
            ...
            price: "1799",
            category_id: beverages.id,
            image: "https://images-na.ssl-images-amazon.com/images/I/51PYyCpMAJL.jpg",
...
Item.create(title: "Nesquik Chocolate",
            ...
            price: "980",
            category_id: beverages.id,
            image: "http://www.polyvore.com/cgi/img-thing?.out=jpg&size=l&tid=492054",
...
Item.create(title: "Kahlua Ground Coffee",
            ...
            price: "1449",
            category_id: beverages.id,
            image: "https://i5.walmartimages.com/asr/42a53ca5-6936-4f2b-aa6d-e074adca9aa1_1.5a5571e55ac6d26870e30ae902723d78.jpeg?odnHeight=450&odnWidth=450&odnBg=FFFFFF",
...
Item.create(title: "Zipfizz",
            ...
            price: "1399",
            category_id: beverages.id,
            image: "http://richmedia.channeladvisor.com/ImageDelivery/imageService?profileId=52000717&id=884535&recipeId=243",
...
bath_and_body = Category.create(title: "Bath and Body")
Item.create(title: "Aveeno",
            description: "Oil-free, hypoallergenic",
            price: "183",
            category_id: bath_and_body.id,
            image: "https://resources.shopstyle.com/sim/b1/a6/b1a650054646fcdb4d4263f22fa05742/nexxus-therappe-shampoo-33-8-oz-2-pk.jpg",
...
Item.create(title: "Dove",
            ...
            price: "739",
            category_id: bath_and_body.id,
            image: "http://s7d2.scene7.com/is/image/samsclub/0007940052620_A?wid=1500&hei=1500&fmt=jpg&qlt=80",
...
Item.create(title: "Head & Shoulders",
            ...
            price: "1199",
            category_id: bath_and_body.id,
            image: "http://news.pg.com/sites/pg.newshq.businesswire.com/files/image/image/Head__AND__Shoulders_Anti-Dandruff_Shampoo.jpg",
...
Item.create(title: "Garnier Fructis",
            ...
            price: "799",
            category_id: bath_and_body.id,
            image: "http://www.garnierusa.com/~/media/Images/Garnier/Home/Products/Hair/HairCare/Pure-Clean/Pure-Clean-Shampoo-13oz/P0213_packshot.png?h=400&thn=0&w=307",
...
Item.create(title: "Q-tips",
            ...
            price: "999",
            category_id: bath_and_body.id,
            image: "http://img2.timeinc.net/health/img/web/2012/10/blogs/Q-Tip-Beauty.jpg",
...
Item.create(title: "Prince & Spring",
            ...
            price: "499",
            category_id: bath_and_body.id,
            image: "https://dcmzfk78s4reh.cloudfront.net/r512x400_1462143045924.jpg",
...
Item.create(title: "Nexxus",
            ...
            price: "1799",
            category_id: bath_and_body.id,
            image: "https://malibubeautyjm.files.wordpress.com/2011/05/nexxus1.jpg",
